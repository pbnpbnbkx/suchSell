...
Partial Class Product_ProductTable
    ...
    Protected Sub LoadProduct()
        ...
        Using conn As New SqlConnection
            ...
            HtmlStr.ID = "ViewProduct"

            Using MyDs As New Data.DataSet
                Using reader As New SqlDataAdapter("select top 8 * from ( select data1.圖片,data1.商品編號,data1.商品狀態,data1.入場金幣," & _
                                                   ...
                                                   "data2.會員編號=data3.會員編號 where data1.商品種類=@商品種類 and (data1.商品狀態 = '2')) as Data order by leftBid ", conn)
                    ...
                    For Each sRow In MyDs.Tables("TmpTb").Rows
                        ...
                        MyString.AppendLine("    <tr>")
                        MyString.AppendLine("     <td class='P2' >入 場 費 :</td>")
                        MyString.AppendLine("     <td align='left'>" & sRow("入場金幣").ToString & "</td>")
                        MyString.AppendLine("    </tr>")

                        MyString.AppendLine("    <tr>")
                        MyString.AppendLine("     <td class='P3' >剩餘標數:</td>")
                        MyString.AppendLine("     <td align='left'>" & leftBid & "</td>")
                        MyString.AppendLine("    </tr>")
                        ...
                        Me.container_content_Menu.InnerText = ""
