...
Partial Class Product_ViewProduct
    ...
    Dim eachPagerCounter As Integer = 8

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'Response.Cache.SetExpires(DateTime.UtcNow.AddSeconds(-3))
        ...
        If Not IsPostBack Then
            ...
            Me.Page.ClientScript.RegisterClientScriptBlock(GetType(String), "bodyLoad", "<script>$(""#pType_end"").attr('value'," & sType & ");$(""#pStatus_end"").attr('value'," & pStatus & ");</script>")
        End If
    End Sub
    ...
    Protected Sub LoadProduct(ByVal sType As Integer, ByVal pStatus As Integer)
        ...
        Using conn As New SqlConnection
            ...
            Using MyDs As New Data.DataSet
                Using reader As New SqlDataAdapter("select top " & eachPagerCounter & " * from ( select data1.圖片,data1.商品編號,data1.商品狀態,data1.入場金幣," & _
                    ...
                    For Each sRow In MyDs.Tables("TmpTb").Rows
                        ...
                        MyString.AppendLine("    <Div class=""BOX-1"">" & "<a href='#' onclick=""return loadbidpageEnd(" & SN & ")""><img style='border:0px;' src='" & link & "/Product/" & ResolveClientUrl(PicUrl) & "' /></a> </Div>  ")
                        ...
                        MyString.AppendLine("<tr>")
                        MyString.AppendLine("  <td colspan=""2"" class=""P3"">已結標</td></tr>")
                    ...
                    Me.container_content_Menu_End.Controls.Add(HtmlStr)
    ...
    Protected Sub newPagerData(ByVal index As Integer, ByVal pStatus As Integer, ByVal pType As Integer)
        ...
        If TotalItems <> 0 Then
            ...
            Me.newpager_end.InnerHtml = HtmlStr.ToString
